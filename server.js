...
var CONSENT_TEMPLATES = [
  ...
  },
  {
    ...
    clauses: [
      {
        heading: "Nature of This Appointment",
        body: "This appointment is a {{transactionType}} signing for the property at {{propertyAddress}} for {{lenderName}}. The notary acts as a signing agent: presenting your closing package, directing you to each signature, date, and initial line, notarizing the documents that require it, and returning the executed package."
      },
      {
      ...
      },
      {
        ...
        body: "The notary handles your package as confidential, keeps it secure from the time it is printed to the time it is returned to the lender or title company, and does not retain copies of your loan documents beyond what is required for the journal entry."
      },
      {
